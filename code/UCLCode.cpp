...
void UCLCode::codeDisplay(const UCLCode &code) const
{
    ...
    */
    int width = 32;
    cout << setw(width) << "Version:" << code.getVersion() << "\n";
    cout << setw(width) << "Type of Media:" << code.getTypeOfMedia() << "\n";
    cout << setw(width) << "Prio and Poli:" << code.getPrioAndPoli() << "\n";
    cout << setw(width) << "Flag:" << code.getFlag() << "\n";
    cout << setw(width) << "Parse Rule:" << code.getParseRule() << "\n";
    cout << setw(width) << "Source of Content:" << code.getSourOfCont() << "\n";
    cout << setw(width) << "Category:" << code.getCategory() << "\n";
    cout << setw(width) << "Subcategory:" << code.getSubCategory() << "\n";
    cout << setw(width) << "Topic:" << code.getTopic() << "\n";
    cout << setw(width) << "Copyright and Type of Cont:" << code.getCopyAndTypeOfCont() << "\n";
    cout << setw(width) << "Security Energy Level Code:" << code.getSecuEnerLeveCode() << "\n";
    cout << setw(width) << "Language:" << code.getLanguage() << "\n";
    cout << setw(width) << "Size of Content:" << code.getSizeOfContent() << "\n";
    cout << setw(width) << "Time Stamp:" << code.getTimeStamp() << "\n";
    cout << setw(width) << "Serial Number:" << code.getSerialNumber() << "\n";
    cout << setw(width) << "Multiplex Bytes:" << code.getMultiplexBytes() << "\n";
    cout << setw(width) << "Code Check:" << code.getCodeCheck() << endl;
}

void UCLCode::showCode() const
{
    int width = 32;
    cout << setw(width) << "Version:" << getVersion() << "\n";
    cout << setw(width) << "Type of Media:" << getTypeOfMedia() << "\n";
    cout << setw(width) << "Prio and Poli:" << getPrioAndPoli() << "\n";
    cout << setw(width) << "Flag:" << getFlag() << "\n";
    cout << setw(width) << "Parse Rule:" << getParseRule() << "\n";
    cout << setw(width) << "Source of Content:" << getSourOfCont() << "\n";
    cout << setw(width) << "Category:" << getCategory() << "\n";
    cout << setw(width) << "Subcategory:" << getSubCategory() << "\n";
    cout << setw(width) << "Topic:" << getTopic() << "\n";
    cout << setw(width) << "Copyright and Type of Cont:" << getCopyAndTypeOfCont() << "\n";
    cout << setw(width) << "Security Energy Level Code:" << getSecuEnerLeveCode() << "\n";
    cout << setw(width) << "Language:" << getLanguage() << "\n";
    cout << setw(width) << "Size of Content:" << getSizeOfContent() << "\n";
    cout << setw(width) << "Time Stamp:" << getTimeStamp() << "\n";
    cout << setw(width) << "Serial Number:" << getSerialNumber() << "\n";
    cout << setw(width) << "Multiplex Bytes:" << getMultiplexBytes() << "\n";
    cout << setw(width) << "Code Check:" << getCodeCheck() << endl;
}
